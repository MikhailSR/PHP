...
if (isset($_POST["send"])){
    ...
    $error = False;
    if ($name == ''){
        $name_error = "Зполните поле <em>Ваше имя</em> <br>" . "<br>";
        $error = True;
        exit();
    }
    if ($message == ''){
        $message_error = "Зполните поле <em>Ваш отзыв</em>" . "<br>";
        $error = True;
        exit();
    }
}
		...
		<div id="wrapper">
			...
			<div id="form">
				<form action="#form" method="POST">
					<p><input name="name" class="form-control" placeholder="Ваше имя" value="<?php echo $_SESSION["name"]; ?>"></p>
                    <span style="color: #ff0000"><?php echo $name_error;?></span>
                    <p><textarea name = "message" class="form-control" placeholder="Ваш отзыв"><?php echo $_SESSION["message"]; ?></textarea></p>
                    <span style="color: #ff0000"><?php echo $message_error;?></span>
